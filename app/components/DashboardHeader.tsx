...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return (
    <div className="relative">
      <div
        className={
          "absolute top-20 -right-20 w-40 h-40 rounded-full bg-secondary blur-[50px]"
        }
      />
      <div
        className={
          "absolute top-[50%] left-1/2 -translate-x-1/2 w-[80%] h-40 rounded-full bg-primary-500 blur-[80px]"
        }
      />
      <div
        className={
          "blur-[106px] absolute -top-1/4 left-10 rotate-45 w-40 h-96 rounded-full bg-emerald-800 outline-[30px] outline-primary"
        }
      />
          ...
          <div className="flex items-center justify-between w-full">
            <div className="leading-tight flex items-center space-x-3">
              <div className="relative w-12 h-12">
                ...
                <Image
                  src="/user-avatar.png"
                  className={`w-12 h-12 rounded-full transition-opacity duration-500 ${
