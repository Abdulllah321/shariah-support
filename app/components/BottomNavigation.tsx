...
export default function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 w-full shadow-lg z-[10]" id="bottom-nav">
      <nav className="relative w-full md:w-1/2 h-16 grid grid-cols-2 gap-[3.4rem] text-gray-700 dark:text-gray-300 mx-auto">
        ...
        <div className="absolute -top-[1.75rem] left-1/2 -translate-x-1/2 h-16 w-16 bg-default-50 rounded-full border-b">
          <div className="bg-default-50  border-background  rounded-full border-[8px] w-full h-full">
            <button
              className="rounded-full w-full h-full bg-gradient-to-br from-teal-500 to-blue-500 hover:from-blue-600 hover:to-teal-600 transition duration-300"
              onClick={openModal}
            >
              <div className="text-white flex items-center justify-center">
                <svg
                  ...
                  className="lucide lucide-plus w-8 h-8"
                >
                  <path d="M5 12h14" />
                  <path d="M12 5v14" />
                </svg>
