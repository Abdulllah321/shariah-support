...
const Dashboard: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        recordsSnapshot.forEach((doc) => {
          ...
          monthlyData[recordMonth][activityType] =
            (monthlyData[recordMonth][activityType] || 0) + 1;
      ...
      datasets: [
        {
          ...
          backgroundColor: professionalColors.slice(
            0,
            Object.keys(dataForMonth).length
          ),
          hoverOffset: 6,
        },
      ],
  ...
  return (
    <div className="min-h-screen p-4 md:p-6">
      ...
      <div
        ref={sectionRef}
        className={`flex flex-col items-center w-full p-6 pb-16 mt-10 rounded-2xl border shadow-lg backdrop-blur-md 
      ...
      ${isShowMore ? "max-h-[1200px]" : "max-h-[350px]"}
      `}
      >
        {/* Title */}
        ...
        {loading ? (
            ...
            <AnimatePresence>
              {topActivities.map((activity, index) => {
                ...
                return (
                  <motion.div
                    key={index}
                    className={`relative w-full px-6 py-3 rounded-full border text-center font-semibold flex items-center transition-all duration-500 transform
                    ${
                      rankStyles[index] ||
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">
            No activities recorded yet. Start logging your activities to see
            rankings here! 🚀
          </p>
        )}
      ...
      <div className="mt-10 p-4 md:p-6 bg-white dark:bg-neutral-950 shadow-lg rounded-lg">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">
            Activity Distribution by Month
          </h2>
          <select
